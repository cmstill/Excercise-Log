...
export const replaceExcercise = async (req, res, next) => {
  console.log(`Controller: replaceExcercise(${req.params.id})`);
  res.status(200).json({});
};

export const deleteExcercise = async (req, res, next) => {
  console.log(`Controller: deleteExcercise(${req.params.id})`);
  res.status(200).json({});
};

export const updateExcercise = async (req, res, next) => {
  console.log(`Controller: updateExcercise(${req.params.id})`);
  res.status(200).json({});
};
